...
public:
    ...
    Produto(string marca, string nome,string codigo, int quantidade, double preco)
        : marca(marca), nome(nome), codigo(codigo),quantidade(quantidade), preco(preco) {}
...
public:
    ...
    Compra(string data, string codigo, int quantidade, double valorTotal)
        : data(data), codigo(codigo), quantidade(quantidade),  valorTotal(valorTotal) {}
...
public:
    ...
    Compra comprar(Anuncio anuncioCompra, int quantidade) {
        ...
        string data = "2024-07-07"; 
        Compra compra(data, anuncioCompra.produto.codigo, quantidade, valorTotal);
...
public:
    ...
    Produto criarProduto() {
        ...
        Produto novoProduto(marca, nome, codigo, quantidade, preco);
